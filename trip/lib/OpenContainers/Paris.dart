...
class FrancePage extends StatefulWidget {
  const FrancePage({Key? key}) : super(key: key);
                ...
                children: [
                  ...
                  Positioned(
                      ...
                      child: Container(
                        ...
                        width: MediaQuery.of(context).size.width * 1,
                        child: Text(
                          "Provence in southern France is renowned for its picturesque lavender fields, vibrant markets, and charming villages. One of the most iconic scenes is the sight of endless lavender rows, creating a vibrant purple landscape. ",
                          style: TextStyle(
