...
class SuissePage extends StatefulWidget {
  const SuissePage({Key? key}) : super(key: key);

  @override
  _SuissePageState createState() => _SuissePageState();
}

class _SuissePageState extends State<SuissePage> {
                ...
                children: [
                  ...
                  Positioned(
                      ...
                      child: Container(
                        ...
                        width: MediaQuery.of(context).size.width * 1,
                        child: Text(
                          "The Swiss Alps, situated in the heart of Switzerland, boast breathtaking mountain vistas, pristine lakes, and charming alpine villages.  ",
                          style: TextStyle(
