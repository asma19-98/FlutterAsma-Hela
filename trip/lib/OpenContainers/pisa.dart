...
class PisaPage extends StatefulWidget {
  const PisaPage({Key? key}) : super(key: key);

  @override
  _PisaPageState createState() => _PisaPageState();
}

class _PisaPageState extends State<PisaPage> {
                ...
                children: [
                  ...
                  Positioned(
                      ...
                      child: Container(
                        ...
                        width: MediaQuery.of(context).size.width * 1,
                        child: Text(
                          "The Amalfi Coast in Italy is a coastal paradise renowned for its dramatic cliffs, azure waters, and colorful cliffside villages. The region offers a perfect blend of natural beauty and Mediterranean charm. ",
                          style: TextStyle(
